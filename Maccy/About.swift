...
class About {
  ...
  private var links: NSMutableAttributedString {
    let string = NSMutableAttributedString(string: "Website│GitHub│Support",
                                           attributes: [NSAttributedString.Key.foregroundColor: NSColor.labelColor])
    string.addAttribute(.link, value: "https://github.com/JuYiYang/clipbridge-macos", range: NSRange(location: 0, length: 7))
    string.addAttribute(.link, value: "https://github.com/JuYiYang/clipbridge-macos", range: NSRange(location: 8, length: 6))
    string.addAttribute(.link, value: "https://github.com/JuYiYang/clipbridge-macos/issues", range: NSRange(location: 15, length: 7))
    return string
  }
